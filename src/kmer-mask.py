...
print("mask 32-mers")
print(f'MASK_PROBABILITY: {MASK_PROBABILITY}')
...
class MyModel(LightningModule):
    def __init__(self):
        ...
        self.input_linear_layer = nn.Linear(160, 256)
...
checkpoint_callback = ModelCheckpoint(
        ...
        monitor='valid_acc',
        filename='mask0.1-{epoch:02d}-{valid_acc:.3f}',
        save_top_k=3,
        mode='max',
    )
